#! /bin/bash
python3 ConvLSTM_CM.py -m 'AE' -n '917/CM_340' -i 128 --VM 917 --label 16 --VM_test 340
python3 ConvLSTM_CM.py -m 'LRCN' -n '917/CM_340' -i 128 --VM 917 --label 16 --VM_test 340
